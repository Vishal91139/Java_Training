...
public class StringStack {
    ...
    public void push(String data){
        if(isFull()){
            System.out.println("Stack Overflow, cant add more elements.");
            return;
        }
        arr[++top] = data;
    ...
    public void display(){
        ...
        System.out.print("The elements in order [LIFO] are: ");
        for(int i=top; i>=0; i--){
    ...
    public String peek(){
        ...
        if(isEmpty()){
            System.out.println("Stack underFlow, Cant retrieve top.");
            return null;
        }
        return arr[top];
    }
