package DAY_10.dataStructures.linear.linkedList.problems.palindromeList;
...
public class PalindromeLinkedList {
    public static boolean isPalindrome(ListNode head){
        ...
        temp = head;
        // Now compare the nodes with stack to elements
        while(temp != null){
        ...
        return true; // All the nodes have been checked, so its a plaindrome
    }
